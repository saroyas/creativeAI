...
def create_message_history(query: str, history: List[Message], model: ChatModel) -> List[dict]:
    ...
    if model == ChatModel.GPT_3_5_TURBO: # creative
        ...
        message_history.append({"role": "system", "content": "You are an emotionally intelligent and nuanced friend. And you are going to slowly help me understand how you feel."})
    else: # uncensorreed
