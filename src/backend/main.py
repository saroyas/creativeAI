...
async def improve_prompt(prompt: str) -> str:
    ...
    messages = [
        ...
        {"role": "user", "content": f"Improve this image prompt, making it more detailed and vivid - without changing the original meaning. If there are any underage characters - change and make clear that everyone is over-18 adult with mature features: {prompt}"}
    ]
